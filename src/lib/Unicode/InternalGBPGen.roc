## The purpose of this file is to generate the Unicode.InternalGBP.roc file.
##
...
import Unicode.Helpers exposing [CPMeta, PropertyMap]

main =
    when Arg.list! |> List.get 1 is
        Err _ -> Task.err (InvalidArguments "USAGE: roc run Unicode.InternalGBP.roc -- path/to/package/")
        Ok arg -> File.writeUtf8 "$(Unicode.Helpers.removeTrailingSlash arg)/Unicode.InternalGBP.roc" template
...
template =
    ...
    import Unicode.InternalCP exposing [CP, toU32, fromU32Unchecked]
...
isFuncTemplate =
    ...
    help = \name, current ->
        exp =
            ...
            |> List.map Unicode.Helpers.metaToExpression
            |> Str.joinWith " || "
...
unicodeHexToTest = \(hex, gbpExpected) ->
    u32 = hex |> Str.toUtf8 |> Unicode.Helpers.hexBytesToU32
