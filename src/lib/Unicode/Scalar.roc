...
import Unicode.InternalCP
import Unicode.CodePoint exposing [CodePoint, isValidScalar]
...
toU32 : Scalar -> U32
toU32 = \@Scalar cp -> Unicode.CodePoint.toU32 cp
...
fromU32 = \u32 ->
    ...
    if inRangeA || inRangeB then
        Ok (@Scalar (Unicode.InternalCP.fromU32Unchecked u32))
    else
        Err InvalidScalar
...
appendScalar = \string, u32 ->
    if isValidScalar (Unicode.InternalCP.fromU32Unchecked u32) then
