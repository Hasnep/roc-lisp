## The purpose of this file is to generate the Unicode.InternalEmoji.roc file.
##
...
main =
    when Arg.list! |> List.get 1 is
        Err _ -> Task.err (InvalidArguments "USAGE: roc run Unicode.InternalEmoji.roc -- path/to/package/")
        Ok arg -> File.writeUtf8 "$(Unicode.Helpers.removeTrailingSlash arg)/Unicode.InternalEmoji.roc" template
...
template =
    ...
    import Unicode.InternalCP exposing [CP, toU32]
