...
import Unicode.InternalCP exposing [CP, fromU32Unchecked]
import Unicode.InternalEAW
...
toU32 : CodePoint -> U32
toU32 = Unicode.InternalCP.toU32
...
appendUtf8 = \bytes, codePoint ->
    ...
    if u32 < 0x80 then
        ...
        ## This was an invalid Unicode scalar value, even though it had the Roc type Unicode.Scalar.
...
## The number of UTF-8 bytes it takes to represent this Unicode.Scalar.
    ...
    when cps is
        ...
        [cp, ..] ->
            cpsToStrHelp
                ...
                (Unicode.CodePoint.appendUtf8 bytes cp)
...
eastAsianWidthProperty = \cp ->
    eaw = cp |> toU32 |> Unicode.InternalEAW.eastAsianWidthProperty
    when eaw is
        F -> Fullwidth
        W -> Wide
        A -> Ambiguous
...
visualWidth = \cp ->
    cp |> toU32 |> Unicode.InternalEAW.eastAsianWidth
