## The purpose of this file is to generate the Unicode.InternalEAW.roc file.
##
...
main =
    when Arg.list! |> List.get 1 is
        ...
        Ok arg -> File.writeUtf8 "$(Unicode.Helpers.removeTrailingSlash arg)/Unicode.InternalEAW.roc" template
...
parseLine = \line ->
    ...
    startHexBytes =
        ...
        |> Str.toUtf8
        |> listToParsingState
        |> Unicode.Helpers.takeHexBytes

    endHexBytes =
        when startHexBytes.rest is
            ['.', '.', .. as rest] -> rest |> listToParsingState |> Unicode.Helpers.takeHexBytes
...
mergeOp = \{ merged, merging }, currentValue ->
    if merging.0 == currentValue.0 && (Unicode.Helpers.hexStrToU32 merging.2) + 1 == (Unicode.Helpers.hexStrToU32 currentValue.1) then
        {
            merged,
